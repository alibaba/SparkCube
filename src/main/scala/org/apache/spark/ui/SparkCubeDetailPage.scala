...
class SparkCubeDetailPage(parent: SparkCubeTab)
  ...
  private def generateLoadResources(request: HttpServletRequest): Seq[Node] = {
    // scalastyle:off
      ...
      "/static_cube/contrib/bootstrap-toggle.min.css")} type="text/css"/>
      <link rel="stylesheet" href={UIUtils.prependBaseUri(request,
        "/static_cube/caching/spark-cube-page.css")} type="text/css"/>
      ...
      <script src={UIUtils.prependBaseUri(request,
        "/static_cube/contrib/bootstrap-toggle.min.js")}></script>
      <script src={UIUtils.prependBaseUri(request,
        "/static_cube/caching/spark-cube-detail-page.js")}></script>
    // scalastyle:on
  }
}
